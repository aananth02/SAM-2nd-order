...
#SBATCH --output=/scratch/bcom/aananth2/SAM-2nd-order/experiments/SAM_WRN_GA_n_sharpness%x-%A_%a.out
#SBATCH --error=/scratch/bcom/aananth2/SAM-2nd-order/experiments/SAM_WRN_GA_n_sharpness%x-%A_%a.err
#SBATCH --ntasks=1
