...
#SBATCH --output=/scratch/bcom/aananth2/SAM-2nd-order/experiments/SGD_WRN_%x-%A_%a.out
#SBATCH --error=/scratch/bcom/aananth2/SAM-2nd-order/experiments/SGD_WRN_%x-%A_%a.err
#SBATCH --ntasks=1
